...
function Nskin.Load()
	...
	if string.find(Element, "Bottomcap") or
	   string.find(Element, "Topcap") or
	   (sButton == "HandRight" and string.find(Element, "Body")) then
		Button = sButton
	end
	...
	if sElement == "Oveceptor" and (sButton == "HandDown" or sButton == "HandUp") then
		t = Def.Actor {}
	end
