...
Nskin.ButtonRedir =
{
	...
	HandUpRight = "HandUpLeft",
	HandLrLeft = "HandLrLeft",
	HandLrRight = "HandLrLeft",
}
...
function Nskin.Load()
	...
	local Button = Nskin.ButtonRedir[sButton] or "FootDown"
	...
	if string.find(Element, "Body") or
	   ...
	   string.find(Element, "Roll Head")then
		Button = Nskin.ButtonRedir[sButton] or "FootDown"
	end

	if string.find(Element, "Roll") and
