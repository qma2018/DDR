...
Nskin.ElementRedir =
{
	...
	["Hold BigRed Active"] = "Tap BigRed",
	["Hold Blue Active"] = "Tap Blue",
	["Hold BigBlue Active"] = "Tap BigBlue",
	["Hold Yellow Active"] = "Tap Yellow",
	["Hold BigYellow Active"] = "Tap BigYellow",
...
Nskin.Blank =
{
	...
	["Count Yellow Body Active"] = true,
	["Count Yellow Body Inactive"] = true,
	["Count Yellow Bottomcap Active"] = true,
	["Count Yellow Bottomcap Inactive"] = true,
}
...
function Nskin.Load()
	...
	if not string.find(sElement, "Count") then
