...
return Def.ActorFrame{
	...
	Def.ActorFrame{
		...
		Def.Sprite{
		Texture="Drum Receptor.png",
		},
		Def.Sprite{
			Name="Taiko Left Outside",
			Texture="Outside Receptor.png",
	...
	Def.Model {
		Meshes=NOTESKIN:GetPath("","_RES/HITME.txt"),
		Materials=NOTESKIN:GetPath("","_RES/HITME.txt"),
		Bones=NOTESKIN:GetPath("","_RES/HITME.txt")
	}
}